				...
				<form>
					...
					<div class="relative z-0 w-full mb-12 group">
						<input
							...
							name="floating_email"
							id="floating_email"
							class="block py-5  mb-3 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
							placeholder=" "
							required
						/>
						<label
					...
					<button
						type="submit"
						class="underline underline-offset-8 text-3xl font-bold"
					>
						Contact me
						<AiOutlineArrowRight
							size={30}
